...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void setUserProfile(String user){
        ...
        cmd.setForeground(new Color(252, 182, 209));
        cmd.setFont(new java.awt.Font("sansserif",1,12));
    ...
    public void setTime(String time){
        //Konusma baloncuklarinin altine eklenecek olan saat.
        JLayeredPane layer = new JLayeredPane();
    ...
    public void setImage(boolean right, Icon... image){
       if(image.length>0){
        ...
        layer.setBorder(new EmptyBorder(0,5,-10,5)); // -10 problem cikarabilir. ( 3. deger 0 olacak )
    ...
    public void sentSuccess(){
        if(lbl != null){
            lbl.setIcon(new ImageIcon(getClass().getResource("/com/grup30/icons/tick.png")));
        }
    }
    
    public void seen(){
        if(lbl != null){
            lbl.setIcon(new ImageIcon(getClass().getResource("/com/grup30/icons/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.grup30.swing.JIMSendTextPane();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.PAGE_AXIS));

        txt.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 4, 10));
        txt.setMinimumSize(new java.awt.Dimension(21, 36));
        txt.setSelectionColor(new java.awt.Color(252, 182, 209));
        add(txt);
    ...
    private com.grup30.swing.JIMSendTextPane txt;
