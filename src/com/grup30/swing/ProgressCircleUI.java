...
import com.grup30.swing.Progress.ProgressType;
...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    this.pro=pro;
    imageDown=new ImageIcon(getClass().getResource("/com/grup30/icons/down.png")).getImage();
    imageCancel=new ImageIcon(getClass().getResource("/com/grup30/icons/cancel.png")).getImage();
    imageFile=new ImageIcon(getClass().getResource("/com/grup30/icons/file.png")).getImage();
}
    @Override 
